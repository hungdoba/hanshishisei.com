...
import oldImage from '../../assets/images/Images/system/photos009.jpg';
import boardImage from '../../assets/images/Images/system/photos013.jpg';
import sakeImage from '../../assets/images/Images/system/photos011.jpg';
import childImage from '../../assets/images/Images/system/photos012.jpg';
import treeImage from '../../assets/images/Images/system/photos014.jpg';
        ...
        <ChildContent>
          ...
          <ContentLeft>
            <Content>
              ...
              <Paragraph>
                その後、右往左往しながら、約1年の期間を要し、ここ入四間町ザル入、入四間町牧野農業協同組合の所有地を、当時、代表理事であった根本勝利氏のご理解とご支援もあり、2014年(H26)6月14日の牧野農業協同組合理事会,総会において了承され、【また会おうの約束】の拠点・開拓が始まった。
              </Paragraph>
            </Content>
          </ContentLeft>
          <ContentRight>
          ...
          <ContentLeft>
            <Content>
              <Paragraph>
                「友子」は全国の鉱山にあった徒弟制度であり、江戸期からの鉱山用語で親分、子分の関係を持った坑夫組合(の一員)を指し、「山中友子」「同盟友子」とも呼ばれた友子制度は、独特な掟で結ばれた、互いに助け合う互助制度の精神をもとに、その絆は、実の親や兄弟よりも強いものであったといわれる。全国各地から働きに来た知らない者同士が安心して仲良く暮らせるように始まった強い絆を持つ山中友子制度。時代の流れと共に姿を消した【山中友子】を現代版として復活させ、不易と流行の想いの連鎖の実現を目的に、その長期キャンプ名を【山中友子隊体験村】と名付け、2000年(H12)から実施された。初年度は7市町村32名の子ども達が参加。
              </Paragraph>
            </Content>
          </ContentLeft>
          <ContentRight>
